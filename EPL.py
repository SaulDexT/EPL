...
gfd = (open('ARS.txt', 'r'))
sqw1 = int(gfd.read())
gfd = (open('ASTON.txt', 'r'))
sqw2 = int(gfd.read())
gfd = (open('BOR.txt', 'r'))
sqw3 = int(gfd.read())
gfd = (open('BRAIT.txt', 'r'))
sqw4 = int(gfd.read())
gfd = (open('BRENT.txt', 'r'))
sqw5 = int(gfd.read())
gfd = (open('CHELS.txt', 'r'))
sqw6 = int(gfd.read())
gfd = (open('CITY.txt', 'r'))
sqw7 = int(gfd.read())
gfd = (open('CRISTAL.txt', 'r'))
sqw8 = int(gfd.read())
gfd = (open('EVE.txt', 'r'))
sqw9 = int(gfd.read())
gfd = (open('FOREST.txt', 'r'))
sqw10 = int(gfd.read())
gfd = (open('FULL.txt', 'r'))
sqw11 = int(gfd.read())
gfd = (open('LEST.txt', 'r'))
